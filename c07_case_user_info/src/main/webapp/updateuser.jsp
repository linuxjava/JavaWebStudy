...
<div class="container">
    ...
    <form role="form" action="${pageContext.request.contextPath}/updateAccountServlet">
        <!--  隐藏域 提交id-->
        <input type="hidden" name="id" value="${user.id}">

        <label for="username">用户名 :</label>
        <div class="input-group">
            <input type="text" name="username" disabled="disabled" class="form-control" id="username" placeholder="请输入用户名" value="${user.username}">
        </div>

        <div class="form-group">
            <label for="username">性别 :</label>
            <c:if test="${user.gender == '男'}">
                <input type="radio" name="gender" value="男" checked style="margin-left: 10px">男
            ...
            <c:if test="${user.gender == '女'}">
                ...
                <input type="radio" name="gender" value="女" checked style="margin-left: 5px">女
            </c:if>
        </div>
        ...
        <div class="input-group">
            <input type="text" name="email" class="form-control" id="email" placeholder="请输入邮箱"  value="${user.email}"/>
        </div>
